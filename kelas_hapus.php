...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi,"DELETE FROM kelas WHERE idkelas='$tapel'");
		if($sql > 0){
		...
		echo '<a href="./admin.php?hlm=master&sub=kelas&aksi=hapus&submit=ya&tapel='.$tapel.'" class="btn btn-sm btn-success">Ya, Hapus</a> ';
